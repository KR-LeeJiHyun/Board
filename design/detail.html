                ...
                <ul class="menu category_list">
                    <li class="category_list_item">
                        <div class="category_box">
                            <div class="category category_active">
                                자유게시판
                            </div>
                        </div>
    ...
    <div class="container">  
        ...
        <div class="comment_box">
            ...
            <div class="comment_writer">
                ...
                <textarea class="comment_input_area" placeholder="댓글을 입력하세요" onkeydown="resize(this)" onkeyup="resize(this)"></textarea>
